# Generated by Django 5.0.4 on 2024-05-08 15:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('basket_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cartitems', to='lullaby.basket')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('updated_date', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
                ('basket_item_objects', models.ManyToManyField(to='lullaby.basketitem')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_date', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
                ('brand_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lullaby.brand')),
                ('category_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lullaby.category')),
                ('size_object', models.ManyToManyField(to='lullaby.size')),
                ('tag_object', models.ManyToManyField(to='lullaby.tag')),
            ],
        ),
        migrations.AddField(
            model_name='basketitem',
            name='product_object',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lullaby.product'),
        ),
        migrations.AddField(
            model_name='basketitem',
            name='size_object',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lullaby.size'),
        ),
    ]
